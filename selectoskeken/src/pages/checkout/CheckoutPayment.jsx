...
import PaymentOptions from '../../common/formulario/PaymentOptions';
        ...
        <div className="payment">
            ...
            <section className="gradient-bg">
                <Stack className='container checkout-body'>
                    <Breadcrumb>
                        <BreadcrumbItem href='/checkout'>Datos de entrega</BreadcrumbItem>
                        <BreadcrumbItem active href='/checkout/payment'>Proceso de pago</BreadcrumbItem>
                    </Breadcrumb>
                    <Stack className="form-container">
                        <CartOverview total='Total: $600.00' cardsEnabled={false} />
                                ...
                                <>
                                    ...
                                    <Stack>
                                        <DeliveryAddress
                                            ...
                                            setField={setField}
                                            title='Facturación'
                                            subtitle='Escoge la dirección a facturar.' />
                                    </Stack>
                                </>
                                :
                                <>
                        ...
                        <Row>
                            <Col lg={true}><button className="btn-dorado btn-submit" onClick={(e) => handleSubmit(e)}>Realizar el pago</button></Col>
                        </Row>
                    </Stack>
                </Stack>
            </section>
